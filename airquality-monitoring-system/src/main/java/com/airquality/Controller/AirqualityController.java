...
public class AirqualityController {
	...
	// localhost:8080/invaliddata
	@GetMapping("/invalidData")
	public List<Airqualitymonitor> getInvalidData() {
		return excelService.listOfInvalidData();
	}

	// localhost:8080/dustpartical

	@GetMapping("/dustpartical")
	public Map<String,List<Integer>> getDustparticals() {
		return Map.of("Dust Paticals", excelService.listOfAirqualitymonitors().stream()
				.map(Airqualitymonitor::getDustParicle)
